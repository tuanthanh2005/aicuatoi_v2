        ...
        <div class="container">
            <div class="about-card" data-aos="fade-up">
                ...
                <p style="font-size: 16px; line-height: 1.8; margin-bottom: 30px;">
                    AiCuaToi.com là nền tảng cung cấp giải pháp công nghệ, công cụ AI và sản phẩm số chất lượng cho cộng đồng Việt Nam.
                ...
                <h3 class="section-title mt-5">
                    <i class="fas fa-handshake me-2"></i>Tại Sao Tin Tưởng AiCuaToi?
                </h3>
