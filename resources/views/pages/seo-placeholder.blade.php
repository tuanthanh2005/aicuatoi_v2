...
@section('title', 'Mua tài khoản ' . $keywordTitle . ' giá rẻ | Bản quyền chính hãng - AiCuaToi.com')
@section('meta_description', 'Dịch vụ cấp tài khoản ' . $keywordTitle . ' Pro giá rẻ, uy tín, bảo hành đầy đủ tại AiCuaToi.com. Đăng ký nhận thông báo pre-order ngay hôm nay.')
...
<div class="container">
    ...
    <div class="seo-preorder-hero text-center" data-aos="fade-up">
        ...
        <p class="lead mx-auto mb-5 text-slate-300" style="max-width: 700px; color: #cbd5e1; font-size: 1.1rem; line-height: 1.6;">
            AiCuaToi.com đang tiến hành thử nghiệm, liên hệ nhà phát hành và chuẩn bị nguồn hàng bản quyền chất lượng cao nhất cho sản phẩm <strong>{{ $keywordTitle }}</strong>. Đăng ký thông tin của bạn bên dưới để nằm trong danh sách nhận thông báo sớm nhất và nhận mã giảm giá 10% khi có hàng!
        </p>
            ...
            <div class="col">
                <div class="ai-card-custom">
                    <div class="ai-card-img-wrap">
                        <img src="{{ $p->image ?? 'https://via.placeholder.com/300x225?text=AiCuaToi+AI' }}" alt="{{ $p->name }}" loading="lazy">
                    </div>
