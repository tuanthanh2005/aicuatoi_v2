<footer class="footer-techfeed">
    <div class="container">
        ...
        <div class="footer-copy">{{ date('Y') }} AiCuaToi.com &mdash; Made with <i
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content" style="border-radius: 20px; border: none;">
                ...
                <div class="modal-body p-4" style="font-size: 15px; line-height: 1.8; color: #4a5568;">
                    ...
                    <p>AiCuaToi.com là nền tảng cung cấp giải pháp công nghệ, công cụ AI và sản phẩm số chất lượng hàng đầu cho cộng đồng Việt Nam. Chúng tôi cam kết mang lại giá trị tốt nhất cho khách hàng với sản
                        phẩm chất lượng cao và giá cạnh tranh.</p>

                    <h6 class="fw-bold mb-3 mt-4" style="color: #667eea;">✨ Tại Sao Chọn AiCuaToi?</h6>
                    <ul class="ms-3">
                    ...
                    <div class="alert alert-success mt-4" style="border-radius: 12px;">
                        ...
                        <strong>Cảm ơn bạn đã tin tưởng AiCuaToi.com!</strong>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content" style="border-radius: 20px; border: none;">
                ...
                <div class="modal-body p-4" style="font-size: 15px; line-height: 1.8; color: #4a5568;">
                    ...
                    <p>AiCuaToi.com có hàng ngàn khách hàng tiềm năng hàng tháng. Chúng tôi cung cấp các giải pháp quảng
