...
@push('styles')
    ...
    <style>
        ...
        @media (min-width: 1200px) { .pgrid { grid-template-columns: repeat(5, 1fr); gap: 14px; } }
        @media (min-width: 1400px) { .pgrid { grid-template-columns: repeat(6, 1fr); gap: 14px; } }

        /* Compact card styling overrides on desktop */
        @media (min-width: 992px) {
            .pcard {
                ...
                <div class="hero-inner">
                    ...
                    <div class="hero-search-wrapper">
                        <form action="{{ route('shop') }}" method="GET" class="hero-search-form">
                            ...
                            <input type="text" name="search" placeholder="Nhập tên sản phẩm..."class="search-input" required autocomplete="off">
