...
class GroqChatService
{
    ...
    public function chat(string $message, string $sessionId, ?int $userId = null): array
    {
        try {
            ...
            return [
                'success' => false,
                'message' => 'Xin lỗi, tôi gặp lỗi kỹ thuật. Vui lòng liên hệ support: support@aicuatoi.com',
                'session_id' => $sessionId,
            ];
        }
    }
    ...
    {
        return <<<'PROMPT'
Bạn là customer support chatbot của aicuatoi.com, một nền tảng bán:
...
📧 Có gì thắc mắc? Contact: support@aicuatoi.com | ☎️ 0772698113
...
- Luôn end với: "📧 support@aicuatoi.com | ☎️ 0772698113 | 💬 Zalo: 0708910952"
