...
class BlogTopicSeeder extends Seeder
{
    private const BLOG_TOPICS = [
        'ai' => [
            ...
            'title' => 'Blog AI, công cụ trí tuệ nhân tạo - AiCuaToi.com',
            'description' => 'Tổng hợp bài viết về AI, công cụ trí tuệ nhân tạo, mẹo sử dụng và cập nhật xu hướng AI mới tại AiCuaToi.com.',
            'aliases' => ['ai', 'trí tuệ nhân tạo', 'artificial intelligence'],
        ],
        'chatgpt' => [
            'label' => 'ChatGPT',
            'heading' => 'Hướng dẫn ChatGPT và GPT Plus',
            'title' => 'Hướng dẫn ChatGPT, GPT Plus - AiCuaToi.com',
        ...
        'cursor' => [
            ...
            'title' => 'Hướng dẫn Cursor AI, Cursor Pro - AiCuaToi.com',
        ...
        'gemini' => [
            ...
            'title' => 'Hướng dẫn Gemini Advanced - AiCuaToi.com',
        ...
        'claude' => [
            ...
            'title' => 'Hướng dẫn Claude AI, Claude Code - AiCuaToi.com',
        ...
        'vpn' => [
            ...
            'title' => 'Hướng dẫn VPN, bảo mật tài khoản - AiCuaToi.com',
        ...
        'office' => [
            ...
            'title' => 'Mẹo dùng Office 365, Microsoft 365 - AiCuaToi.com',
        ...
        'canva' => [
            ...
            'title' => 'Hướng dẫn Canva Pro, thiết kế nhanh - AiCuaToi.com',
        ...
        'youtube' => [
            ...
            'title' => 'Mẹo dùng YouTube Premium - AiCuaToi.com',
        ...
        'hoc-tap' => [
            ...
            'title' => 'Công cụ học tập và làm việc hiệu quả - AiCuaToi.com',
